...
import com.jaden.entity.UserGroup;
...
public class UserService {
    ...
    private List<com.jaden.entity.User> toMyUser(List<User> userList) {
        List<com.jaden.entity.User> myUserList = new ArrayList<>();
        for (User user : userList) {
            com.jaden.entity.User myUser = new com.jaden.entity.User();
    ...
    public Object addUser(com.jaden.entity.User user) {
